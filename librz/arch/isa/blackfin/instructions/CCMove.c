...
bool DisassembleCCMove(uint16_t instructionWord, struct Instruction *instr, bool parallel) {
	...
	if (T)
		instr->operands[1].flags.cc_inverted = false;
	else
	...
	instr->operands[3].operat = OPER_EQ;
