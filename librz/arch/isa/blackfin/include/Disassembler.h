...
static int _disasm_insn_bfin(uint32_t instructionCandidate, uint32_t addr, Instruction *result, bool parallel);
int disasm_insn_bfin(uint8_t *data, uint32_t addr, Instruction *instr);
